...
Returns the market-maker score weights per symbol used in Bitget's maker rebate programme. The `category` filter is optional; omit it to retrieve weights for all categories.
